...
#     list_of_consepts_to_run.append(
#         input("The name of Variables to be activated {} =  ".format(i + 1))
#     )


# change_level = {}
# for c in list_of_consepts_to_run:
#     change_level[c] = float(
#         input(
#             "What is the Activation Level of {}. (Please choose between [-1,+1])    ".format(
#                 c
#             )
#         )
#     )
